...
<div class="row">
  <div class="grid_4 preffix_4 centrar_form">
    <label style="color: white; font-weight: bold;">Usuario</label> <br>
    <input type="text" id="user"> <br>
    <label style="color: white; font-weight: bold;">Contraseña</label> <br>
    <input type="text" id="pass"> <br>
    <button class="btn_login" id="login">
      Login     
    </button>
  </div>
</div>
